...
**Codmac** é um repositório em desenvolvimento que centraliza códigos, macros e comandos usados no dia a dia para automação, produtividade e suporte técnico.  
Ele reúne soluções práticas em **VBA, CMD e PowerShell**, funcionando como uma base pessoal e técnica de referência para execução rápida, reaproveitamento de scripts e organização de conhecimento operacional.
